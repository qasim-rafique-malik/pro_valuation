    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="panel panel-inverse">
                <div class="panel-heading"> @lang("modules.issues.addIssue")</div>
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        {!! Form::open(['id'=>'createIssue','class'=>'ajax-form','method'=>'POST']) !!}
                        <div class="form-body">
                            <div class="row">
                                <div class="col-xs-12">
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('client.my-issues.store')}}',
            container: '#createIssue',
            type: "POST",
            redirect: true,
            data: $('#createIssue').serialize()
        })
    });
</script>
@endpush
