    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($invoice->items as $item)
            ...
            <tr style="page-break-inside: avoid;">
                ...
                <td class="qty"><h3>{!! currency_position($item->unit_price, $invoice->currency->currency_symbol) !!}</h3></td>
                <td class="unit">{!! currency_position($item->amount, $invoice->currency->currency_symbol) !!}</td>
            </tr>
            @endif
        @endforeach
        <tr style="page-break-inside: avoid;" class="subtotal">
            ...
            <td class="unit">{!! currency_position($invoice->sub_total,htmlentities($invoice->currency->currency_symbol)) !!}</td>
        </tr>
        <tr style="page-break-inside: avoid;" class="discount">
            ...
            <td class="unit">-{!! currency_position($discount, htmlentities($invoice->currency->currency_symbol)) !!}</td>
        </tr>
        ...
        <tr dontbreak="true">
            ...
            <td>{!! currency_position($invoice->total, htmlentities($invoice->currency->currency_symbol)) !!}</td>
        </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
