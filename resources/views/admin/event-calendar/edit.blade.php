...
<div class="modal-body">
    ...
    <div class="form-body">
       ...
       <div class="col-md-6 ">
        ...
        <div class="row">
            <div class="col-xs-12">
                <a href="javascript:;" id="show-attendees" class="text-info"><i class="icon-people"></i> @lang('modules.events.viewAttendees') (<span id="attendeesCount">{{ count($employees) }}</span>)</a>
            </div>
