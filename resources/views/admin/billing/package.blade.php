                ...
                <div class="table-responsive table-responsive-froid">
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tr>
                            ...
                            @foreach($packages as $package)
                                <td>
                                    @if((round($package->monthly_price) > 0  || $package->is_free == 1) && $package->default == 'no')
                ...
                <div class="table-responsive table-responsive-froid">
                    <table class="table table-hover table-bordered text-center">
                        ...
                        <tr>
                            ...
                            @foreach($packages as $package)
                                <td class="@if(($package->id == $company->package->id && $company->package_type == 'annual')) selected-plan @endif">
                                    <h3 class="panel-title price"> {{ currency_position(number_format($package->annual_price),$package->currency->currency_symbol) }}</h3>
                                </td>
                            @endforeach
                        </tr>
                        ...
                        <tr>
                            ...
                            @foreach($packages as $package)
                                <td>
                                    @if((round($package->annual_price) > 0  || $package->is_free == 1) && $package->default == 'no')
