                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="time_format" id="time_format" class="form-control select2">
                                                    <option value="h:i A" @if($global->time_format == 'h:i A') selected @endif >12 Hour  ({{ $dateObject->format('h:i A') }}) </option>
                                                    <option value="h:i a" @if($global->time_format == 'h:i a') selected @endif >12 Hour  ({{ $dateObject->format('h:i a') }}) </option>
                                                    <option value="H:i" @if($global->time_format == 'H:i') selected @endif >24 Hour  ({{ $dateObject->format('H:i') }}) </option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
