...
class ExpensesDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addIndexColumn()
            ->rawColumns(['action', 'status', 'user_id', 'item_name'])
    ...
    public function query(Expense $model)
    {
        ...
        $model = $model->select('expenses.id', 'expenses.item_name', 'expenses.user_id', 'expenses.price', 'users.name', 'expenses.purchase_date', 'expenses.currency_id', 'currencies.currency_symbol', 'expenses.status', 'expenses.purchase_from', 'expenses.expenses_recurring_id')
